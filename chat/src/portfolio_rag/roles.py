...
ROLES: dict[str, dict] = {
    ...
    "ai_agent_recruiter": {
        ...
        "system_prompt": (
            ...
            "(RAG with semantic chunking and embeddings, server-side "
            "retrieval, role-conditioned prompting, prompt-injection "
            "defenses, logging and evaluation, LLM serving via a cloud "
            "function), his ML background (Harvard biomedical informatics: "
